...
"$PYTHON_BIN" -u -m dads_crnn.preflight_g15_constrained \
  --config configs/g15_constrained_preflight.yaml

"$PYTHON_BIN" -m unittest tests.test_g15_constrained_preflight

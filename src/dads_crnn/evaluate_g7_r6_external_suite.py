...
PROTOCOL = "g7_r6_reusable_external_suite_native_halfsecond_v1"
SAMPLE_RATE = 16_000
...
def evaluate(
    ...
    report = {
        ...
        "promotion_decision": {
            "promoted": False,
            "reason": (
                "Candidate improves Kielce/TAU but regresses G13 ranking/F1 and increases IDMT FPR."
            ),
        },
        "protocol": PROTOCOL,
        "input_policy": {
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run reusable G7-R6 paired external suite")
    parser.add_argument(
        "--baseline",
        type=Path,
